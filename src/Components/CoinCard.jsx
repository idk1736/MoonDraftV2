...
export default function CoinCard({ coin, onTrade, href }) {
  return (
    <a href={href}>
      <div className="relative flex items-center justify-between gap-4 p-3 rounded-md hover:bg-white/5 transition">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            onClick={(e) => { e.stopPropagation(); onTrade(coin); }}
          >
            Trade
          </button>
        </div>
